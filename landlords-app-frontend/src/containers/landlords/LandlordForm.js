            ...
            <div>
                <form onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <div>
                        ...
                        <input type="text" name="state" id="state" value={this.state.state} onChange={this.handleChange} />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="number_of_houses" id="number_of_houses" value={this.state.number_of_houses} onChange={this.handleChange} />
                    </div>
